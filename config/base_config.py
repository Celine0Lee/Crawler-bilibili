...
# False：避免部分环境下 CDP WebSocket 502，使用 Playwright 自带 Chromium（仍可扫码登录）
...
# False：由程序自动拉起 Chrome 并占用调试端口（本机未提前开远程调试时可直接运行）
...
# Crawl interval (seconds between comment API calls)
